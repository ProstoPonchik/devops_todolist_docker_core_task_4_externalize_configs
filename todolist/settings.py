...
DATABASES = {
    'default': {
        'ENGINE': ENGINE,  # Use the ENGINE environment variable
        'NAME': NAME,  # Use the NAME environment variable
        'USER': USER,  # Use the USER environment variable
        'PASSWORD': PASSWORD,  # Use the PASSWORD environment variable
        'HOST': HOST,  # Use the HOST environment variable
